...
% subjects = [031 032 033 034 035 036 037 038 039 040 041 042 043 044 045 046 047 048 049 050];
% subjects = [051 052 053 054 055 056 057];
% subjects = [059 060 061 062 063 064 065 066 067 068 069];
subjects = [058 059];
...
matlabbatch{6}.cfg_basicio.file_dir.file_ops.file_move.files = {
                                                                ['/mnt/projects/7TPD/bids/' subject '/ses-01prisma3t/fmap/sub-' subj_no '_ses-01prisma3t_acq-hardiref_dir-PA_run-01_epi.json']
...
matlabbatch{8}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files = {
                                                                       ['/mnt/projects/7TPD/bids/' subject '/ses-01prisma3t/fmap/sub-' subj_no '_ses-01prisma3t_acq-hardiref_dir-PA_run-01_epi.nii.gz']
...
matlabbatch{11}.spm.tools.hmri.autoreor.other = {
                                                 ...
                                                 ['/mnt/scratch/7TPD/mpm_run_acu/bids/' subject '/ses-01prisma3t/fmap/sub-' subj_no '_ses-01prisma3t_acq-hardiref_dir-PA_run-01_epi.nii,1']
