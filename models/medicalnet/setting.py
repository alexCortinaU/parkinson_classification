...
def get_def_args():
    ...
    args.data_root = './data'
    args.img_list = './data/train.txt'
    args.n_seg_classes = 2
    args.learning_rate = 0.001
    args.num_workers = 4
    args.batch_size = 1
    args.phase = 'train' # 'train' for pretrained, 'test', for versions 4C and 6C
    ...
    args.input_W = 448
    args.resume_path = ''
    args.pretrain_path = 'pretrain/resnet_10_23dataset.pth' # 'pretrain/resnet_10_23dataset.pth', for pretrained, False, for versions 4C and 6C
