...
def get_def_args():
    ...
    args.num_workers = 4
    args.batch_size = 1
    args.phase = 'test' # 'train' for pretrained, 'test', for versions 4C and 6C
    ...
    args.input_W = 448
    args.resume_path = ''
    args.pretrain_path = False # 'pretrain/resnet_10_23dataset.pth', for pretrained, False, for versions 4C and 6C
