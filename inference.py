...
if __name__ == '__main__':
    ...
    for map_type, exps_paths in EXP_DIR.items():
    ...
    predictions.to_csv(results_path/f'4_{phase}_inference_results.csv', index=False)
    results.to_csv(results_path/f'4_{phase}_exps_results.csv', index=False)
