...
def main():
    ...
    exp_name = 'R2s_R2s_SyNRA_CC'
    print(f'exp_name: {exp_name}')
    transform_type = 'SyNRA' # antsRegistrationSyNQuick[s], SyN, SyNRA
    ...
    r1_map_path = base_path / f'{subj}_ses-01prisma3t_echo-01_part-magnitude-acq-MToff_MPM_R2s_WLS1_w.nii'
